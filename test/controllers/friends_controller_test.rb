...
class FriendsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create friend" do
    assert_difference('Friend.count') do
      post friends_url, params: { friend: { content: @friend.content, title: @friend.title } }
    end
  ...
  test "should update friend" do
    patch friend_url(@friend), params: { friend: { content: @friend.content, title: @friend.title } }
