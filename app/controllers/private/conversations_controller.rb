class Private::ConversationsController < ApplicationController
  def create
  recipient_id = Apost.find(params[:post_id]).user_id
  ...
  if @conversation.save
    ...
    respond_to do |format|
      format.js {render partial: 'aposts/show/contact_user/message_form/success'}
    end
  else
    respond_to do |format|
      format.js {render partial: 'aposts/show/contact_user/message_form/fail'}
    end
  end
end
def close
